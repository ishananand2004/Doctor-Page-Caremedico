  ...
  return (
    <>
      <div className="px-20 py-10 flex justify-evenly gap-40">
        ...
        <div className="translate-x-[40px] translate-y-[30px]">
          <Link
            href="https://caremedico.in/"
            className="bg-red-500 px-20 py-3 hover:bg-red-600 rounded-md text-[#fff] border border-[#000]"
          >
            Book Appointment
          </Link>
          <Link
            href="https://web.whatsapp.com/"
            className=" px-20 items-center text-[#fff] py-3 mt-10 flex gap-2 bg-green-500 hover:bg-green-600 border border-[#000] rounded-md"
          >
            <FaWhatsapp />
            <h1>WhatsApp us</h1>
          </Link>
